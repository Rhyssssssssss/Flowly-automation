      ...
      <section className="mt-[-500px]">
        ...
        <div className="-mt-72 flex flex-col flex-wrap items-center justify-center gap-8 md:flex-row">
          <CardContainer className="inter-var">
            <CardBody className="group/card relative h-auto w-full rounded-xl border border-black/[0.1] bg-gray-50 p-6 md:!w-[350px] dark:border-white/[0.2] dark:bg-black dark:hover:shadow-2xl dark:hover:shadow-neutral-500/[0.1]">
              <CardItem
                translateZ="50"
          ...
          <CardContainer className="inter-var">
            <CardBody className="group/card relative h-auto w-full rounded-xl border border-black/[0.1] bg-gray-50 p-6 md:!w-[350px] dark:border-[#E2CBFF] dark:bg-black dark:hover:shadow-2xl dark:hover:shadow-neutral-500/[0.1]">
              <CardItem
                translateZ="50"
                className="text-xl font-bold text-neutral-600 dark:text-white"
              >
